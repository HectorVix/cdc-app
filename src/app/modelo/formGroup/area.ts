...
export class area_FormGroup {
    ...
    getAreaFormGrup(row: area_Modelo): FormGroup {
        ...
        return fb.group({
            ...
            'nummarg': new FormControl(row.nummarg, Validators.maxLength(20)),
            ...
            'codpostaladmin': new FormControl(row.codpostaladmin, Validators.maxLength(20)),
            'telefadminist': new FormControl(row.telefadminist, Validators.maxLength(5)),
            ...
            'respdatos': new FormControl(row.respdatos, Validators.maxLength(60)),
