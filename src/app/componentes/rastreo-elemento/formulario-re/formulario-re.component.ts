...
export class FormularioReComponent implements OnInit {
  ...
  onChange_Reino() {
    ...
    if (this.reForm.get('reinoId').value) {
      this.rastreoServicio.obtener_Phylum(this.reForm.get('reinoId').value)
      this.criterio_Phylum = this.rastreoServicio.phylum_Valor
    }
  }
  onChange_Phylum() {
    if (this.reForm.get('phylumId').value) {
      this.limpiar_onChange_Taxones(1)
      this.rastreoServicio.obtener_Clase(this.reForm.get('phylumId').value)
  ...
  onChange_Clase() {
    if (this.reForm.get('claseId').value) {
      this.limpiar_onChange_Taxones(2)
      this.rastreoServicio.obtener_Orden(this.reForm.get('claseId').value)
  ...
  onChange_Orden() {
    if (this.reForm.get('ordenId').value) {
      this.limpiar_onChange_Taxones(3)
      this.rastreoServicio.obtener_Familia(this.reForm.get('ordenId').value)
  ...
  onChange_Familia() {
    if (this.reForm.get('familiaId').value) {
      this.limpiar_onChange_Taxones(4)
      this.rastreoServicio.obtener_Genero(this.reForm.get('familiaId').value)
  ...
  onChange_Genero() {
    if (this.reForm.get('generoId').value) {
      this.limpiar_onChange_Taxones(5)
      this.rastreoServicio.obtener_Especie(this.reForm.get('generoId').value)
  ...
  onChange_Especie() {
    if (this.reForm.get('especieId').value) {
      this.limpiar_onChange_Taxones(6)
      this.rastreoServicio.obtener_Infraspecificepithet(this.reForm.get('especieId').value)
  ...
  limpiar_onChange_Taxones(taxon) {
    switch (taxon) {
      case 0://reino
        this.criterio_Phylum = []; this.reForm.get('phylumId').setValue('');
        this.criterio_Clase = []; this.reForm.get('claseId').setValue('');
        this.criterio_Orden = []; this.reForm.get('ordenId').setValue('');
        this.criterio_Familia = []; this.reForm.get('familiaId').setValue('');
        this.criterio_Genero = []; this.reForm.get('generoId').setValue('');
        this.criterio_Especie = []; this.reForm.get('especieId').setValue('');
        this.criterio_Infraspecificepithet = []; this.reForm.get('infraspecificepithetId').setValue('');
        break;
      case 1://phylum
        this.criterio_Clase = []; this.reForm.get('claseId').setValue('');
        this.criterio_Orden = []; this.reForm.get('ordenId').setValue('');
      ...
      case 6://especie
        ...
        this.reForm.get('infraspecificepithetId').setValue('')
        break;
    }
